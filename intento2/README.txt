...
Descripción:
    ...
    Si el valor resultante es negativo, el proceso se elimina y el lider
...
Consideraciones:
    ...
    - Para nuestro programa, el lider será el proceso con el ID más pequeño.
    - Existe un problema conocido: el proceso hijo ganador a veces no logra
      comunicar correctamente al padre que es el único vivo.
    - Otro problema: Hay veces en las que no realiza bien el envio de token
      y se envia repetido el mismo valor (la causa aún no ha sido identificada).